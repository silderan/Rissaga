...
namespace Ris
{
	...
	public:
		...
		template <typename T>
		inline Point2D &operator+=(const T& scalar) { x += scalar; y += scalar; return *this; }
		template <typename T>
		inline Point2D &operator-=(const T& scalar) { x -= scalar; y -= scalar; return *this; }
		template <typename T>
		inline Point2D &operator*=(const T& scalar) { x *= scalar; y *= scalar; return *this; }
		...
		inline Point2D &operator/=(const T& scalar) { x /= scalar; y /= scalar; return *this; }
		template <typename T>
		inline Point2D &operator%=(const T& scalar) { x = (T)((int)x % (int)scalar); y = (T)((int)y % (int)scalar); return *this; }
		template <typename T>
